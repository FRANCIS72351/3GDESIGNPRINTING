...
class WhatsAppOrderTests(unittest.TestCase):
    ...
    def test_finalize_whatsapp_order(self, _mock_image, _mock_bg):
        ...
        self.assertIn('🛒 Order from 3G DESIGN GLOBAL', message_text)
    ...
    def test_build_order_copy_text_has_no_url(self):
        ...
        self.assertIn('🛒 Order from 3G DESIGN GLOBAL', text)
    ...
    def test_order_share_page_has_single_primary_cta(self, _mock_image, _mock_bg):
        ...
        self.assertIn('Send Order to 3G DESIGN GLOBAL on WhatsApp', html)
